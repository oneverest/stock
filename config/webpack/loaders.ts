...
const getLocalIdentWorkaround = (context: any, localIdentName: any, localName: any, options: any) => {
...
const fileLoaderServer = {
  exclude: [/\.(js|tsx|ts|tsx|css|mjs|html|ejs|json|pug)$/],
  use: [
    {
      loader: require.resolve('file-loader'),
      options: {
...
export const server = [
  {
    ...
    oneOf: [babelLoader, cssModuleLoaderServer, cssLoaderServer, urlLoaderServer, fileLoaderServer, pugLoaderServer],
  },
];
